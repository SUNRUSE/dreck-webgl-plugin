  ...
  describe(`on generating data`, () => {
    describe(`when valid`, () => {
      ...
      describe(`returns bytes including`, () => {
        ...
        function Attribute(
          ...
          it(key, () => {
            ...
            for (
              ...
              const expectedBytes = bytes[vertexIndex] as ReadonlyArray<number>;
        ...
        Attribute(`floatVec4`, [
          [228, 197, 21, 70, 205, 204, 92, 66, 72, 165, 6, 69, 66, 150, 20, 68],
          [
            100, 251, 211, 69, 154, 121, 174, 69, 113, 249, 67, 70, 26, 23, 190,
            71,
          ],
          [
            106, 236, 233, 67, 188, 36, 242, 195, 154, 153, 49, 66, 119, 190,
            172, 65,
          ],
          [
            88, 250, 197, 69, 225, 122, 109, 66, 0, 72, 15, 69, 51, 211, 120,
            68,
          ],
          [
            72, 73, 27, 70, 154, 153, 236, 67, 205, 204, 37, 68, 154, 65, 187,
            69,
          ],
        ]);
      });
