...
describe(`renderIndexed`, () => {
  ...
  describe(`when the vertex buffer is from another context`, () => {
    ...
    beforeAll(() => {
      ...
      contextRender = jasmine.createSpy(`render`);
      context = {
        gl: {
          useProgram,
          bindBuffer,
    ...
    beforeAll(() => {
      ...
      indexBufferGetInstance = jasmine
        ...
        .and.returnValue({
          ...
          data: { count: 224, type: Constants.UnsignedShort },
        });
      const indexBuffer = {
        context,
        throwIfDisposed: indexBufferThrowIfDisposed,
  ...
  describe(`when successful`, () => {
    ...
    it(`binds the index buffer`, () => {
      expect(bindBuffer).toHaveBeenCalledWith(Constants.ElementArrayBuffer, {
        test: `indexBuffer`,
      });
    });
