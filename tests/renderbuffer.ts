...
describe(`Renderbuffer`, () => {
  function Scenario<TFormat extends RenderbufferFormat>(
    description: string,
    format: TFormat
  ) {
    describe(description, () => {
      describe(`on construction`, () => {
        ...
        let context: ContextInterface<
          ...
          | `isContextLost`
        >;
        let renderbuffer: Renderbuffer<TFormat>;
        ...
        beforeAll(() => {
          ...
          renderbuffer = new Renderbuffer<TFormat>(context, format, 640, 428);
        });
  ...
  Scenario(`RGBA4`, Constants.Rgba4);
  Scenario(`RGB565`, Constants.Rgb565);
  Scenario(`RGBA5551`, Constants.Rgba5551);
  Scenario(`depth`, Constants.DepthComponent16);
  Scenario(`stencil`, Constants.StencilIndex8);
  Scenario(`depth stencil`, Constants.DepthStencil);
});
